...
```scss
@forward 'pkg:@maddimathon/design-system-utilities/templates/astro/config' with (
    ...
);
```
...
```scss
@forward 'pkg:@maddimathon/design-system-utilities/templates/astro/tokens' with (
    ...
);
```
...
@forward 'pkg:@maddimathon/design-system-utilities/templates/astro';
...
@use 'pkg:@maddimathon/design-system-utilities/templates/astro' as lib;
