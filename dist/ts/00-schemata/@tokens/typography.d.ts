...
export declare const Typography: z.ZodObject<{
...
export interface Partial_CSS {
    ...
    size?: {
        [P in keyof z.infer<typeof Typography.shape.size>]?: (z.infer<typeof Typography.shape.size>[P] extends object ? Partial<z.infer<typeof Typography.shape.size>[P]> : z.infer<typeof Typography.shape.size>[P]) | undefined;
    };
}
