 ...
 * @since 0.1.0-alpha.draft
 */
export declare class Tokens extends AbstractTokens<typeof Schemata.Tokens, Tokens.Export, Schemata.PartialTokens, Tokens.JSON, Tokens.ScssVars> {
...
export declare namespace Tokens {
    ...
    interface JSON extends Omit<z.infer<typeof Schemata.Tokens>, "spacing" | "typography"> {
