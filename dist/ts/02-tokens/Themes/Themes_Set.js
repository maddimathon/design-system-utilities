    ...
    class SingleMode extends AbstractTokens {
        ...
        static async build(preset, brightness, clrNames, input, overrides = {}) {
            ...
            return SingleMode.Build.data({
                levels,
                variations,
            }).then((defaultInputData) => new SingleMode(description, levelsInUse, mergeArgs(defaultInputData, mergeArgs(defaultOverrides, overrides, true), true)));
        }
    ...
    (function (SingleMode) {
        ...
        (function (Build) {
            ...
            async function data(input) {
                ...
                const heading = objectGenerator(SingleMode.allHeadingLevels, (hdgNum) => clrOpt(variations.heading[hdgNum] ?? variations.heading[10], levels.heading[hdgNum]));
                const link = {
