...
export declare namespace ColourUtilities {
    ...
    namespace Levels {
        ...
        function max<T_Level extends Levels.Optional | Levels.Required>(arr: ["black" | "white" | T_Level, ...("black" | "white" | T_Level)[]]): "black" | "white" | T_Level;
        function max<T_Level extends Levels.Optional | Levels.Required>(arr: ("black" | "white" | T_Level)[]): "black" | "white" | T_Level | undefined;
        function min<T_Level extends Levels.Optional | Levels.Required>(arr: ["black" | "white" | T_Level, ...("black" | "white" | T_Level)[]]): "black" | "white" | T_Level;
        function min<T_Level extends Levels.Optional | Levels.Required>(arr: ("black" | "white" | T_Level)[]): "black" | "white" | T_Level | undefined;
        /**
