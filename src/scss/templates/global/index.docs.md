...
```scss
@forward 'pkg:@maddimathon/design-system-utilities/templates/global/config' with (
    ...
);
```
...
```scss
@forward 'pkg:@maddimathon/design-system-utilities/templates/global/tokens' with (
    ...
);
```
...
@forward 'pkg:@maddimathon/design-system-utilities/templates/global';
...
@use 'pkg:@maddimathon/design-system-utilities/templates/global' as lib;
